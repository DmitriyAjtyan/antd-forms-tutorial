...
Для валидации email используем страшное регулярное выражение с вот этого сайта: https://uibakery.io/regex-library/email (RFC 5322 compliant regex)
В случае ошибки будем просто выводить сообщение "Вы ввели некорректный email". Как оно должно выглядеть можете посмотреть на макете 10.
<br>
