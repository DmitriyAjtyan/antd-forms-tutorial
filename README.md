...
Задание 14.
<br>
Вам не кажется, что мы упустили одну важную деталь при валидации паролей? Да, в правила валидации полей "Пароль" и "Повторите пароль" нужно добавить ещё одно правило: введённые пароли должны совпадать. При несовпадении паролей ошибка должна появляться сразу на двух полях и не пропадать до тех пор, пока пароли не совпадут. Как должна выглядеть эта ошибка можно увидеть на макете 14.
<br>
